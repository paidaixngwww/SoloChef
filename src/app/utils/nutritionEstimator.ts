...
const NUTRITION_MAP: Record<string, NutritionPer100g> = {
  ...
  猪肝: [19.3, 3.5, 5.0, 0], 鸡肝: [16.6, 4.8, 2.8, 0], 鸭肝: [14.5, 7.5, 2.0, 0], 肝: [19.3, 3.5, 5.0, 0],
  猪肚: [15.2, 5.1, 0.7, 0], 猪腰: [15.4, 3.2, 0.8, 0], 猪蹄: [22.6, 18.8, 0, 0],
  肥肠: [6.5, 18.1, 0, 0], 大肠: [6.5, 18.1, 0, 0], 猪心: [16.9, 5.3, 1.1, 0],
  猪舌: [17.0, 16.0, 0, 0], 猪耳: [22.5, 7.2, 0, 0],
  鸡胗: [19.2, 2.8, 0.4, 0], 鸭胗: [17.0, 2.0, 1.3, 0],
  牛肚: [14.8, 1.6, 0, 0], 牛百叶: [14.8, 1.6, 0, 0], 毛肚: [14.8, 1.6, 0, 0],
  黄喉: [8.0, 0.8, 0, 0], 鹅肝: [15.2, 3.4, 9.0, 0], 腰花: [15.4, 3.2, 0.8, 0],
  ...
  // 西式/沙拉类调味料（每10g/ml）[蛋白质, 脂肪, 碳水, 膳食纤维]
  蜂蜜: [0.03, 0, 8.2, 0], 柠檬汁: [0.04, 0, 0.7, 0], 柠檬: [0.04, 0, 0.7, 0],
  沙拉汁: [0.1, 0.5, 2.0, 0], 沙拉酱: [0.1, 6.0, 2.5, 0],
  千岛酱: [0.1, 4.0, 3.0, 0], 蛋黄酱: [0.1, 7.5, 0.3, 0],
  芥末酱: [0.4, 0.3, 0.5, 0.3], 黑胡椒: [1.0, 0.3, 4.4, 2.5], 黑胡椒粉: [1.0, 0.3, 4.4, 2.5],
  海盐: [0, 0, 0, 0], 红酒醋: [0, 0, 0.3, 0], 意大利醋: [0.05, 0, 1.5, 0],
  味噌: [1.2, 0.6, 2.6, 0.5], 味醂: [0.03, 0, 4.3, 0], 寿司醋: [0, 0, 3.2, 0],
  韩式辣酱: [0.4, 0.2, 4.5, 0.4], 芝麻: [1.8, 5.0, 2.3, 1.2],
};
...
export function generateNutritionTips(
  ...
  if (!isLowCal && fatPct > 0.45 && fat > 20) {
    const fatSourceDesc = topFatSources.length === 1
      ? `主要来自${topFatNames}，贡献了约 ${topFatRatio}% 的脂肪`
      : `主要来自${topFatNames}，两者合计贡献了约 ${topFatRatio}% 的脂肪`;
    tips.push({
      icon: '🔥',
      title: '高脂肪',
      content: `这道菜的热量和脂肪${fatSourceDesc}，属于高脂肪菜品。`,
    });
